...
# 배경 이미지 불러오기
background = pygame.image.load("C:/Users/sksk0/Desktop/project/PythonWorkspace/pygame_basic/background.png")

# 캐릭터(스프라이트) 불러오기
character = pygame.image.load("C:/Users/sksk0/Desktop/project/PythonWorkspace/pygame_basic/character.png")
...
# 적 enemy 캐릭터
enemy = pygame.image.load("C:/Users/sksk0/Desktop/project/PythonWorkspace/pygame_basic/enemy.png")
...
while running:
    ...
    pygame.display.update() # 게임 화면을 다시 그리기. (계속 호출이 되어야함)
